...
import time
from sklearn.model_selection import KFold
import login_data as load_data
...
#Data Load
x_train,y_train = load_data.MCNN_data_load(x_train_pt,y_train_pt,NUM_CLASSES,NUM_DEPENDENT)
x_test,y_test = load_data.MCNN_data_load(x_test_pt,y_test_pt,NUM_CLASSES,NUM_DEPENDENT)
